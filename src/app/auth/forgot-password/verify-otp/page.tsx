  ...
  return (
    <AuthShell title="忘記密碼" subtitle="請確認您的身分以繼續">
      <div className="rounded-t-2xl bg-base-200 px-6 py-5">
        <p className="text-sm text-base-content/60">輸入驗證碼以繼續重設密碼</p>
      </div>

      <div className="px-6 py-6 space-y-6">
        <Stepper step={2} labels={["輸入信箱", "驗證身份", "設定新密碼"]} />

        <div className="bg-base-200 border border-base-300 p-5 text-sm text-base-content rounded-2xl">
          <p className="font-semibold text-base-content mb-2">驗證碼已發送</p>
          <p className="leading-6">
            我們已將 6 位數驗證碼傳送到您的信箱：
            <span className="font-semibold text-base-content break-words">
              {email}
            </span>
          </p>
        </div>
        ...
        <div className="space-y-4">
          ...
          <Link
            ...
            className="flex items-center justify-center gap-1 text-xs text-base-content/60 hover:text-base-content transition-colors"
          >
