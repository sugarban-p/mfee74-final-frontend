  ...
  return (
    <AuthShell title="電子郵件驗證" subtitle="請查收驗證信">
      <div className="space-y-6">
        <div className="alert bg-base-200 rounded-xl p-4 text-sm flex items-start gap-2.5 border-base-300">
        ...
        <div className="flex gap-2 justify-center py-1">
          {otp.map((v, i) => (
            <input
              ...
              className="w-12 h-12 rounded-xl border-2 border-[#E7DDD3] bg-[#FFF8F1] text-[#2F2A26] text-center text-xl font-bold shadow-sm outline-none transition-all focus:border-[#E97C37] focus:ring-2 focus:ring-[#F6C6A0]/50"
            />
          ))}
        </div>
